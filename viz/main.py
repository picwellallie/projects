...
@app.route('/')
def default():
    return render_template('index.html', data = vpc_data_sg_order("vpc-8ada78ef"))

@app.route('/databricks')
def databricks():
    return render_template('index.html', data = vpc_data_sg_order("vpc-6d5fd208"))

@app.route('/staging')
def staging():
    return render_template('index.html', data = vpc_data_sg_order("vpc-1d39cf78"))

@app.route('/uat')
def uat():
    return render_template('index.html', data = vpc_data_sg_order("vpc-ba0cc7df"))
